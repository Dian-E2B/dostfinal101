    ...
    <div class="sidebar-content js-simplebar">
        <a class='sidebar-brand'>
            <div class="row">
                <span class="sidebar-brand-text align-items-center col-4">
                    <img style="max-width: 70px; max-height: 70px;" src="{{ asset('icons/dost_seal.png') }}"
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ request()->is('seilist') || request()->is('seilist2') ? 'active' : '' }}">
                ...
                <ul id="seilist1"
                    class="sidebar-dropdown list-unstyled collapse {{ request()->is('seilist') || request()->is('seilist2') ? 'show' : '' }}"
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{ request()->is('seilist') ? 'active' : '' }}"><a class='sidebar-link'
                            href='{{ route('seilist') }}'>Qualifiers</a>
                    </li>
                    <li class="sidebar-item {{ request()->is('seilist2') ? 'active' : '' }}"><a class='sidebar-link'
                            href='{{ route('seilist2') }}'>Potential Qualifiers </a></li>
                </ul>
            </li>
            ...
            <li
                class="{{ request()->is('accesscontrol') ||
                ...
                request()->is('accesscontrolterminated')
                    ? 'sidebar-item active'
                    : 'sidebar-item' }}">
                ...
                <ul id="accesscont1"
                    class="sidebar-dropdown list-unstyled collapse {{ request()->is('accesscontrol') ||
                    request()->is('accesscontrolongoing') ||
                    request()->is('accesscontrolpending') ||
                    request()->is('accesscontrolenrolled') ||
                    request()->is('accesscontroldeferred') ||
                    ...
                    <li class="sidebar-item {{ request()->is('accesscontrol') ? 'active' : ' ' }}"><a
                    ...
                    <li class="sidebar-item {{ request()->is('accesscontrolLOA') ? 'active' : ' ' }}"><a
                            class='sidebar-link' href='{{ route('accesscontrolLOA') }}'>LOA </a></li>
                    <li class="sidebar-item {{ request()->is('accesscontrolterminated') ? 'active' : ' ' }}"><a
                            class='sidebar-link' href='{{ route('accesscontrolterminated') }}'>Terminated </a></li>
                </ul>
            </li>
